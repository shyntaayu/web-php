<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 no-underline">
                        <div class="flex items-center justify-center w-8 h-8 bg-gray-800 text-white font-bold rounded">
                            SJ
                        </div>
                        <h1 class="text-xl font-bold text-gray-800 m-0">
                            SIJAM <small class="text-sm font-normal text-gray-500">v1.0</small>
                        </h1>
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="url('/kontak')" :active="request()->is('kontak')">
                Kontak
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="url('/mahasiswa')" :active="request()->is('mahasiswa*')">
                Mahasiswa
            </x-responsive-nav-link>
        </div>
